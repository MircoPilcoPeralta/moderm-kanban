...
import { loadTasksRequest, loadTasksSuccess, loadTasksFailure, addTask, removeTask, updateTask } from "../actions/task.actions";
...
export const taskReducer = createReducer(
    ...
    on(loadTasksSuccess, (state, { tasks }) =>
        taskAdapter.setAll(tasks, { ...state, isLoading: false, error: null })
    ),
